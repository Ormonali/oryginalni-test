      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.greetingContainer}>
          ...
          <View style={styles.greetingTextContainer}>
            ...
            <Text style={styles.subheader}>
              Sprawdz co mozesz dzisiaj zrobic!
            </Text>
          </View>
        </View>
        <Spacer height={20} />
        ...
        <View style={styles.card}>
          <Text style={styles.daysLeft}>
            Do wydarzenia zostało <Text style={styles.bold}>386 dni</Text>
          </Text>
          <View style={styles.row}>
            <Text style={styles.header}>
              Dobrze Ci idzie! <br />
              Uzupełniaj checklistę dalej!
            </Text>
        ...
        <View style={styles.cardGlass}>
          ...
          <IconButton
            onPress={() => router.navigate("/informacje-targowe")}
            Icon={RightBtnIcon}
          />
        </View>
        <View style={styles.cardGlass}>
          ...
          <IconButton
            onPress={() => router.navigate("/portal-dokumentow")}
            Icon={RightBtnIcon}
          />
        </View>
        <View style={styles.cardGlass}>
          ...
          <IconButton
            onPress={() => router.navigate("/materialy-marketingowe")}
            Icon={RightBtnIcon}
          />
        </View>
        <View style={styles.cardGlass}>
